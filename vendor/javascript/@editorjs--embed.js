...
/**
   ...
   */}set data(e){if(!(e instanceof Object))throw Error("Embed Tool data should be object");const{service:t,source:i,embed:r,width:o,height:a,caption:n=""}=e;this._data={service:t||this.data.service,source:i||this.data.source,embed:r||this.data.embed,width:o||this.data.width,height:a||this.data.height,caption:n||this.data.caption||""};const s=this.element;s&&s.parentNode.replaceChild(this.render(),s)}
/**
   * @returns {EmbedData}
...
/**
   ...
   */onPaste(e){const{key:t,data:i}=e.detail,{regex:r,embedUrl:o,width:a,height:n,id:s=(e=>e.shift())}=m.services[t],h=r.exec(i).slice(1),c=o.replace(/<%= remote_id %>/g,s(h));this.data={service:t,source:i,embed:c,width:a,height:n}}
/**
   * Analyze provided config and make object with services to use
   *
   * @param {EmbedConfig} config - configuration of embed block element
   */static prepare({config:t={}}){const{services:i={}}=t;let r=Object.entries(e);const o=Object.entries(i).filter((([e,t])=>typeof t=="boolean"&&t===!0)).map((([e])=>e)),a=Object.entries(i).filter((([e,t])=>typeof t=="object")).filter((([e,t])=>m.checkServiceConfig(t))).map((([e,t])=>{const{regex:i,embedUrl:r,html:o,height:a,width:n,id:s}=t;return[e,{regex:i,embedUrl:r,html:o,height:a,width:n,id:s}]}));o.length&&(r=r.filter((([e])=>o.includes(e)))),r=r.concat(a),m.services=r.reduce(((e,[t,i])=>t in e?(e[t]=Object.assign({},e[t],i),e):(e[t]=i,e)),{}),m.patterns=r.reduce(((e,[t,i])=>(e[t]=i.regex,e)),{})
/**
   * Check if Service config is valid
   *
   * @param {Service} config - configuration of embed block element
   * @returns {boolean}
   */}static checkServiceConfig(e){const{regex:t,embedUrl:i,html:r,height:o,width:a,id:n}=e;let s=t&&t instanceof RegExp&&i&&typeof i=="string"&&r&&typeof r=="string";return s=s&&(n===void 0||n instanceof Function),s=s&&(o===void 0||Number.isFinite(o)),s=s&&(a===void 0||Number.isFinite(a)),s
/**
